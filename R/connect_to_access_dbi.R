# Connect to access database via DBI function (to enable use with dbplyr package)
# From icj's answer on https://stackoverflow.com/questions/46458092/connection-from-access-to-r-via-dbi/48390093#48390093
